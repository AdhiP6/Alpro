...
void menuSorting(){
    ...
    cout << "3. Insertion Sort (berdasarkan harga)\n";
    cout << "==========================================\n";
}
...
void insertionSort(Barang* toko, int jumlahbarang, bool ascending) {
    cout << "\nData sebelum diurutkan (berdasarkan harga):\n";
    cout << "==========================================\n";
    tampilkanBarang(toko, jumlahbarang);
    for (int i = 1; i < jumlahbarang; i++) {
        ...
        while (j >= 0) {
            bool condition = false;
            if (ascending) {
                condition = ((toko + j)->harga > key.harga);
            } else {
                condition = ((toko + j)->harga < key.harga);
            }
    ...
    cout << "\nData setelah diurutkan " << (ascending ? "(rendah ke tinggi)" : "(tinggi ke rendah)") << ":\n";
    cout << "==========================================\n";
    tampilkanBarang(toko, jumlahbarang);
    system("pause");
}
...
void menuUrutkan(Barang* toko, int jumlahbarang) {
    ...
    switch (pilih) {
        ...
        case 3: {
            cout << "\033c";
            cout << "\n==========================================\n";
            cout << "     INSERTION SORT (Berdasarkan Harga)\n";
            cout << "==========================================\n";
            int urut = PilihanUrutan();
            bool ascending = (urut == 1);
            cout << "\033c";
            insertionSort(toko, jumlahbarang, ascending);
            break;}
        default:
            cout << "\033c";
